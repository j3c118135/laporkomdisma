...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="<?php echo base_url('admin/dosen/simpan'); ?>" class="needs-validation" novalidate>
                <?= csrf_field();?>
                    ...
                    <table class="table table-striped" id="tableUser" width="100%" cellspacing="0">
                        ...
                        <?php $no=1; 
                            ...
                            <tr>
                                ...
                                <input type="checkbox" class="custom-control-input check-item" name='id[]' value="<?=$dosen->id_akun?>" id="checkitem<?=$dosen->id_akun?>">
                                <label class="custom-control-label" for="checkitem<?=$dosen->id_akun?>"></label>
                                </div></td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('admin/dosen/import');?>" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
