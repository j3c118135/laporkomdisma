...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      <div class="card-body">
          <form method="POST" action="<?php echo base_url('grafik/sv'); ?>">
              <div class="form-row">
              ...
              <script>
                ...
                var pelanggaranKategori = new Chart(ctx, {
                  ...
                  options: {
                    title: {
                        display: true,
                        text: "Total Pelanggaran Mahasiswa Per Bulan dengan Kategori Pelanggaran <?= $pelanggaranKategori[2];?> dan Jenis Pelanggaran <?= $pelanggaranKategori[3]?>"
                    },
                    maintainAspectRatio: false,
                    layout: {
                      padding: {
            ...
            <script>
              ...
              var pelanggaranLokasi = new Chart(ctx, {
                ...
                options: {
                  title: {
                      display: true,
                      text: "Total Pelanggaran Mahasiswa Per Bulan di <?= $pelanggaranLokasi[2];?>"
                  },
                  maintainAspectRatio: false,
                  layout: {
                    padding: {
            ...
            <script>
              ...
              var pelanggaranSanksi = new Chart(ctx, {
                ...
                options: {
                  title: {
                      display: true,
                      text: "Total Pelanggaran Mahasiswa Per Bulan dengan Sanksi <?= $pelanggaranSanksi[2];?>"
                  },
                  maintainAspectRatio: false,
                  layout: {
                    padding: {
