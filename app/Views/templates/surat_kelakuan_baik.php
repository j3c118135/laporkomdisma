    ...
    <!--Surat-->
        <div class="surat" style="margin : 0 25px">
            ...
            <table align='center'>
                ...
                <p class="judul" style="margin-top:-15px" align="center">Nomor : 260/Komdisma/XII/<?php echo date('Y');?></p>
                <br>
                <br>                
                    <div class="isi-surat">
                        <table class="tabel-surat-mahasiswa" style="padding-left:30px;">
                            ...
                            <tr>
                                ...
                                <p>Selama dalam pengawasan kami sampai surat keterangan ini diterbitkan tidak pernah terlibat dalam pelanggaran Tatatertib Kehidupan Kampus.</p>
                    ...
                    <table style="padding-left:30px;" >
                        <tr>
                            ...
                            <p><img src="https://raw.githubusercontent.com/komdismasvipb/ttdsurat/main/foto/janganDihapus.jpeg" style="height:125px;"></p>
                            ...
                            <p style="padding-bottom:40px; top:-10px;">Bogor, <?php setlocale(LC_TIME, 'id_ID'); echo strftime("%d %B %Y",strtotime($tgl_pengajuan));?></p>
                            <p>Koordinator Komisi Disiplin dan Kemahasiswaan</p>
                            <p style="margin-top:-15px;">Sekolah Vokasi IPB</p>
                            <p><img src="https://raw.githubusercontent.com/komdismasvipb/ttdsurat/main/foto/Dr.%20drh.%20Aryani%20Sismin%20Satyaningtijas%2C%20MSc..jpg" style="height:125px;"></p>
